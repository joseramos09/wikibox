...
<head>
    <meta charset="utf-8">
    <title>@yield('title', 'Megaupload Database')</title>
...
<div class="container">
    <nav class="navbar navbar-expand-lg navbar-light" style="background-color:  #ff7c00;">
        <a class="navbar-brand" href="{{ route('root') }}">MEGAUPLOAD</a>
            ...
            <ul class="navbar-nav mr-auto">
                <li class="nav-item dropdown">
                    ...
                    <div class="dropdown-menu" aria-labelledby="navbarDropdown">
                        <a class="dropdown-item" href="{{ route('files.index') }}">Lista de Archivos</a>
